...
function Ask({setques}){
  ...
  }} placeholder='Ask anything..' name="question" value={text} id="query" />
            <button onClick={handleClick} id="mic"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" >
